...
At the same time, the role itself was exploratory: there was no existing model for turning daily BBC programming into social content at scale, and part of the challenge was to assess whether this could become a sustainable, long-term approach for the organisation.
      `.trim(),
      approach: `
...
Following this work, the BBC recommended me directly to Netflix, where I went on to support the development of its UK digital content strategy the following year.
  ...
  // ---- More work / thumb wall ----

  {
    title: "Research & Public Engagement",
...
As an editor, I worked on Shell’s *Everyday Experts* series, directed by Paul Berczeller, using humour and character to translate complex technical processes into accessible, shareable content.
      ...
      { type: "youtube", ids: ["Hf_nds6e84A", "R2PS00fEbJ8"] },
      {
        type: "text",
        value: `
I’ve also edited action-led branded films for the British Army, where tone, clarity and pacing were critical to maintaining credibility and trust.
      ...
      { type: "youtube", ids: ["lstn3wOEO08", "JdHkElXZePE"] },
      {
        type: "text",
        value: `
...
Across all branded projects, my focus is on shaping content that audiences choose to engage with — ensuring brands are represented with clarity, consistency and intent. The goal is work that performs because it resonates, not because it interrupts.
      ...
      { type: "youtube", ids: ["y77S-baMITQ", "NeQuER6GO2s", "qwL1-zZ7-jI", "ziP37-P4hw4"] },
    ],
...
They supported public engagement during lockdown and beyond, with one primary school using the films daily as a calming start to the school day, reflecting the project’s wider social value.
...

  {
    ...
    description: "Editing work supporting family-friendly content with broad appeal.",
    sections: {},
    content: [
      {
        type: "text",
...
The repeated commissions across markets reflected a high level of trust in my ability to deliver under pressure, adapt quickly to live conditions, and turn ambitious experiential work into social films that performed at global scale.
...

  {
    ...
    description: "A selection of music video work across different artists and styles.",
    sections: {},
    content: [
      {
        type: "text",
...
Alongside directing, I’ve edited music videos for artists including Bloc Party, Frank Carter & The Rattlesnakes, Hot Chip, Public Service Broadcasting, Glasvegas, George Ezra, Ellie Goulding, Pitbull and Enrique Iglesias.
      ...
      { type: "youtube", ids: ["VVPulAbfAj0", "WFJPYi3JXw4", "DDgekKQ8nLc"] },
      {
        type: "text",
        value: `
Across both roles, music video work remains an important creative outlet — a place to stay close to visual culture, work directly with artists, and continually refine my storytelling instincts.
...

  {
    ...
    description: "Editorial and production work supporting streaming content delivery.",
    sections: {},
    content: [
      {
        type: "text",
...
The approach established a lightweight model for documenting internal programmes in a way that supports public engagement and institutional goals.
    ...
    embeds: {
      secondary: { youtubeIds: ["o1HZy9WeIss", "W7I3EC9gX9Y", "XkVziGKlKwo"] },
    },
...
The project reflects my approach to factual storytelling: finding the human story within complexity, questioning default formats, and shaping narratives that serve both the audience and the people at the centre of the film.
      ...
      { type: "youtube", ids: ["YOUTUBE_ID_PLACEHOLDER_1", "YOUTUBE_ID_PLACEHOLDER_2"] },
    ],
    tags: [
      "Factual",
      "Long-form Editing",
...
Across this work, I focused on clarity, pacing and tone — shaping films that could cut through in short formats while still serving brand strategy and creative intent.
...

  {
    ...
    description:
      "One tree spotlight a week — beautifully shot and thoughtfully presented.",
    layout: "videoWall",
    sections: {
      approach: `
I’m a keen woodworker and lover of all things wooden, including, of course, trees.

I’d been reading brilliant books about trees: their biology, the biodiversity they support, their symbiotic partnerships, and the relationship they have with us (or, I should say, we with them).

We’ve exploited trees for shelter, fuel, war, medicine and myth — but so many people can’t tell an ash from an alder.

So I set myself the challenge of filming 52 trees: not just once, but documenting them through the seasons, and presenting each one in a way that helps with identification while also exploring its cultural place, ecological role and the sheer variety of its traits.

Below are a few of my favourites. The full playlist is linked here too.
      `.trim(),
    },
    links: [
      {
        label: "Watch the full Tree Tuesday playlist",
        url: "https://youtube.com/playlist?list=PLryojAZrOX_ZqLailwwUvsCHUrHBcwbe4&si=N0p8eBPoxv9NucwY",
      },
      {
        label: "Woodwork on Instagram",
        url: "https://www.instagram.com/herts_wood/",
      },
    ],
    embeds: {
      secondary: {
    ...
    tags: ["Nature", "Series", "Cinematography", "Personal Project"],
  },

  {
    ...
    gallery: [
      { src: "/projects/tell-moi/screen-1.jpg", alt: "Tell Moi app – home screen", caption: "Home screen" },
      { src: "/projects/tell-moi/screen-2.jpg", alt: "Tell Moi app – question prompt", caption: "Question prompt" },
      { src: "/projects/tell-moi/screen-3.jpg", alt: "Tell Moi app – results or scoring screen", caption: "Results screen" },
    ],
    links: [{ label: "View on the App Store", url: "https://apps.apple.com/gb/app/tell-moi/id6758162695" }],
